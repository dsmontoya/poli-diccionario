...
class CarrerasControllerTest < ActionController::TestCase
  ...
  test "should create carrera" do
    assert_difference('Carrera.count') do
      post :create, carrera: { descripcion: @carrera.descripcion, nombre: @carrera.nombre, url: @carrera.url }
    end
  ...
  test "should update carrera" do
    patch :update, id: @carrera, carrera: { descripcion: @carrera.descripcion, nombre: @carrera.nombre, url: @carrera.url }
    assert_redirected_to carrera_path(assigns(:carrera))
  end
